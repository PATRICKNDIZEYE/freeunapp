      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            detailedDescription: scholarship.detailedDescription || '',
            amount: scholarship.amount || '',
            amountType: scholarship.amountType || 'PARTIAL',
            category: scholarship.category || 'COMPUTER_SCIENCE',
            degreeLevel: scholarship.degreeLevel || 'BACHELOR',
            ...
            qualificationBasis: scholarship.qualificationBasis || '',
            awardsAvailable: scholarship.awardsAvailable?.toString() || '',
            contactInfo: scholarship.contactInfo || '',
            referenceUrl: scholarship.referenceUrl || '',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">Update scholarship information</p>
            </div>
          </div>
